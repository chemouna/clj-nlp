(ns clj-nlp.training.time
  "Function to train a better (than the NER provided by OpenNLP)
   date/time model."
  (:use [clj-nlp.training.core :as traincore]
        [clj-nlp.time :as timec]
        [clj-nlp.math-utils :as utils])
  (:require
   [opennlp.nlp :as nlp]
