(defproject clj-nlp "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "clj-nlp.core/on-figwheel-reload"}

                :compiler {:main clj-nlp.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/clj-nlp.js"
